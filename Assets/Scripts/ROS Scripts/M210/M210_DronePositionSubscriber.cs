namespace ISAACS
{
    ...
    public class M210_DronePositionSubscriber : MonoBehaviour {
        ...
        public new static void CallBack(ROSBridgeMsg msg)
        {
            ...
            GameObject cube = WorldProperties.selectedDrone.gameObjectPointer;
            ...
            if (cube != null)
            {
                ...
                {
                    initialPosition.x = pose._lat;
                    initialPosition.y = pose._altitude;
                    initialPosition.z = pose._long;
                    Debug.Log("Set initial position to : " + initialPosition);
                }
                else
                {
                    pose._lat -= initialPosition.x;
                    pose._altitude -= initialPosition.y;
                    pose._long -= initialPosition.z;
                }
        ...
        public static Vector3 M210_RosSpaceToWorld(float _lat, float _altitude, float _long)
        {
            ...
            return new Vector3(_lat * 10000, _altitude+3.0f, _long * 10000);
